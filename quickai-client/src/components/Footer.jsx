...
const Footer = () => {
  return (
    <footer className="w-full bg-white text-gray-600 px-6 md:px-16 lg:px-24 xl:px-32 pt-12 mt-12 sm:mt-20 border-t border-gray-200">
      <div className="flex flex-col md:flex-row justify-between gap-12 pb-10 border-b border-gray-300">
        {/* Logo and Description */}
        <div className="max-w-md">
          <img src={assets.logo} alt="PrismAI Logo" className="h-10" />
          <p className="mt-6 text-sm leading-relaxed">
            Experience the power of AI with <strong>PrismAI</strong>. Transform
      ...
      <div className="text-center text-xs md:text-sm mt-6 pb-6 text-gray-500">
        ...
        <p className="mt-1">
          GitHub:{" "}
          <a href="https://github.com/sumu9897" className="hover:text-primary">
            gopalpayghan
          </a>
        </p>
      </div>
