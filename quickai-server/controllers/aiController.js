...
export const generateImage = async (req, res) => {
  try {
    ...
    console.log("Image generation request:", { userId, prompt, publish, plan });
    ...
    console.log("Creating FormData with prompt:", prompt);
    ...
    // Skip Cloudinary upload for now - use base64 directly
    const secure_url = base64Image;

    console.log("Using base64 image directly (Cloudinary skipped)");
